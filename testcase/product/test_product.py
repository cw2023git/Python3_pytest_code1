...
class Test1:
    ...
    def test_1(self,my_product): #此方法中直接使用此‘前置’函数 注意：无需每个测试用例都加上‘my_fix’，可使用autouse=True
    # def test_1(self,aaa): #直接使用‘别名’aaa即可【了解即可，意义不大】
        print('这是个我文档管理')

        print('------------'+str(my_product)+'--------------') #把前置函数打印出来
...
if __name__ == '__main__':
    pytest.main()
    os.system('allure generate ./report_temp -o ./report_allure --clean')
